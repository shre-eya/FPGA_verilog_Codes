...
HD_PWD='C:/FPGA_lab/lab/modified_booth/modified_booth.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log modifeid_booth.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source modifeid_booth.tcl -notrace
